...
public partial class searchLast : System.Web.UI.Page
{
    ...
    public int CalculateRecord()
    {
        int intCount;
        //
        string extraS = Request.QueryString["ssearch"].ToString();
        string strCount = "select * from T_Commodity where articleName  Like '%" + extraS + "%'";
    ...
    ICollection CreateSource()
    {
        ...
        string strSel ="select * from T_Commodity where articleName Like '%" + extraS + "%'";
