...
public partial class device : System.Web.UI.Page
{
    ...
    {
        int intCount;
        string phone1 = "device";
        string strCount = "select * from T_Commodity where articledevice='" + phone1 + "'";
    ...
    ICollection CreateSource()
    {
        ...
        string phone1 = "device";
        string strSel = "select * from T_Commodity where articledevice='" + phone1 + "'";
