...
public partial class accessories : System.Web.UI.Page
{
    ...
    {
        int intCount;
        string acceess1 = "accessories";
        string strCount = "select * from T_Commodity where articledevice='" + acceess1 + "'";
    ...
    ICollection CreateSource()
    {
        ...
        string acceess1 = "accessories";
        string strSel = "select * from T_Commodity where articledevice='" + acceess1 + "'";
