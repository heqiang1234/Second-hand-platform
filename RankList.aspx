<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RankList.aspx.cs" Inherits="RankList" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <asp:DataList ID="Data1" runat="server" onItemCommand="buy_Button_Click" CellSpacing="3" CellPadding="0" RepeatColumns="1" RepeatDirection="Horizontal"  HorizontalAlign="center" CssClass="bdmain">
            <ItemTemplate > 
               <table style="height:62px" >
                   <tr>
                       <td >
                       <asp:Image ID="artImg" style="width:50px;height:30px" ImageUrl='<%# DataBinder.Eval(Container.DataItem,"articleImage")%>' runat ="server" />
                           </td>
                       <td colspan="2">
                           </td>
                       </tr>
                   <tr>
                     ...
                     <tr>
                      ...
                      <td>
                       ...
                       <td>
                          <asp:Label ID="artValue" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"articleLoveValue")%>'></asp:Label>
    ...
    <div id="divNewBlock" style=" border:solid 5px;padding:10px;width:600px;z-index:1001; 
        position: absolute; display:none;top:50%; left:10%;margin:-50px;"  runat="server">
            <div style="padding:3px 15px 3px 15px;text-align:left;vertical-align:middle;"  runat="server" >
                <div>
